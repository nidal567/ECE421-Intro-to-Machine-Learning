...
def fit_NeuralNetwork(X_train,y_train,alpha,hidden_layer_sizes,epochs):
    ...
    for epoch in range(epochs):
      ...
      error=0
      for index in jumble:
        #Here we are calculating the forward and backward propagation for each sample
        ...
        #accumulating the error for each sample as specified in the question
      err.append(error/N)
...
def test_Part1():
    ...
    # Answer for PA2_qa 
    # values (5,5), (10,10), (30,10) and keep other parameters the same or as default
